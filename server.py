...
# 投资理财主题励志语录列表
MOTIVATIONAL_QUOTES = [
    {'text': '投资最重要的不是智商,而是耐心和纪律。', 'author': '沃伦·巴菲特'},
    {'text': '别人贪婪时我恐惧,别人恐惧时我贪婪。', 'author': '沃伦·巴菲特'},
    {'text': '投资的第一条准则是不要赔钱,第二条准则是永远不要忘记第一条。', 'author': '沃伦·巴菲特'},
    {'text': '风险来自于你不知道自己在做什么。', 'author': '沃伦·巴菲特'},
    {'text': '价格是你付出的,价值是你得到的。', 'author': '沃伦·巴菲特'},
    {'text': '在别人恐慌时贪婪,在别人贪婪时恐慌。', 'author': '沃伦·巴菲特'},
    {'text': '如果你不愿意持有一只股票十年,那就不要考虑持有它十分钟。', 'author': '沃伦·巴菲特'},
    {'text': '市场短期是投票机,长期是称重机。', 'author': '本杰明·格雷厄姆'},
    {'text': '投资是在不确定中寻找确定性。', 'author': '本杰明·格雷厄姆'},
    {'text': ' diversity is the only free lunch in finance. 分散投资是金融界唯一的免费午餐。', 'author': '哈里·马科维茨'},
    {'text': '投资成功的关键在于控制情绪,而非预测市场。', 'author': '彼得·林奇'},
    {'text': '时间是好公司的朋友,是坏公司的敌人。', 'author': '沃伦·巴菲特'},
    {'text': '不要把所有鸡蛋放在一个篮子里。', 'author': '投资谚语'},
    {'text': '机会总是留给有准备的人,投资也是如此。', 'author': '路易斯·巴斯德'},
    {'text': '投资不是关于比别人更聪明,而是关于控制自己的情绪。', 'author': '霍华德·马克斯'},
    {'text': '最危险的事情是说一切都会好起来。', 'author': '霍华德·马克斯'},
    {'text': '在投资中,承认错误比证明自己正确更重要。', 'author': '乔治·索罗斯'},
    {'text': '市场总是对的,但有时它需要很长时间来证明。', 'author': '杰西·利弗莫尔'},
    {'text': '截断亏损,让利润奔跑。', 'author': '杰西·利弗莫尔'},
    {'text': '耐心是投资者最重要的品质之一。', 'author': '菲利普·费雪'},
    {'text': '股市是一个把钱从急躁者转移到耐心者手中的装置。', 'author': '沃伦·巴菲特'},
    {'text': '投资很简单,但不容易。', 'author': '沃伦·巴菲特'},
    {'text': '永远不要投资你无法理解的业务。', 'author': '沃伦·巴菲特'},
    {'text': '买入被低估的资产,然后耐心等待价值回归。', 'author': '本杰明·格雷厄姆'},
    {'text': '最好的投资就是投资自己。', 'author': '沃伦·巴菲特'},
    {'text': '不要试图预测市场,而是利用市场的错误定价。', 'author': '霍华德·马克斯'},
    {'text': '长期投资不是因为持有时间久,而是因为看得很远。', 'author': '菲利普·费雪'},
    {'text': '投资中最大的风险不是波动,而是你不知道自己在做什么。', 'author': '沃伦·巴菲特'},
    {'text': '成功的投资是关于管理风险,而不是追求收益。', 'author': '乔治·索罗斯'},
    {'text': '市场可以保持非理性的时间,比你保持偿付能力的时间更长。', 'author': '约翰·梅纳德·凯恩斯'},
    {'text': '投资如同人生,关键不在于起点,而在于方向和坚持。', 'author': '投资感悟'},
    {'text': '财富不是朋友,但朋友是财富。投资如此,人生亦然。', 'author': '投资感悟'},
    {'text': '每一笔投资都是对未来的一次投票。', 'author': '彼得·林奇'},
    {'text': '在投资的世界里,慢就是快,稳就是赢。', 'author': '投资感悟'},
    {'text': '不要因为便宜就买入,不要因为贵就卖出。', 'author': '投资感悟'},
    {'text': '市场永远在波动,但优质资产的价值终将显现。', 'author': '投资感悟'},
    {'text': '投资是唯一一个智商越高越容易亏钱的领域,如果你自作聪明的话。', 'author': '查理·芒格'},
    {'text': '反过来想,总是反过来想。', 'author': '查理·芒格'},
    {'text': '能力圈比圈的大小更重要。', 'author': '沃伦·巴菲特'},
    {'text': '投资中,等待正确的球进入击球区比频繁挥棒更重要。', 'author': '泰德·威廉姆斯'},
    {'text': '复利是世界第八大奇迹,理解它的人能赚到它,不理解的人会付出它。', 'author': '阿尔伯特·爱因斯坦'},
    {'text': '财富的积累不在于你赚多少,而在于你留住多少。', 'author': '投资感悟'},
    {'text': '市场先生每天都会报一个价格,你不需要每天都要交易。', 'author': '本杰明·格雷厄姆'},
    {'text': '真正的投资者欢迎波动,因为它创造了机会。', 'author': '沃伦·巴菲特'},
    {'text': '投资不是一场百米冲刺,而是一场马拉松。', 'author': '投资感悟'},
    {'text': '趋势是你的朋友,直到它结束时为止。', 'author': '交易谚语'},
    {'text': '买在分歧,卖在一致。', 'author': '投资谚语'},
    {'text': '投资最大的敌人不是市场,而是你自己。', 'author': '投资感悟'},
    {'text': '恐惧和贪婪是驱动市场的两大情绪,学会驾驭它们。', 'author': '投资感悟'},
    {'text': '每一次危机都孕育着机会,每一次泡沫都暗藏风险。', 'author': '霍华德·马克斯'},
]


@app.route('/api/quote')
def api_quote():
    """每日励志语录 - 基于日期返回固定一条(每天同一语录)"""
    from datetime import date
    today = date.today()
    # 用天数索引选语录,确保每天固定
    day_index = today.toordinal()
    quote = MOTIVATIONAL_QUOTES[day_index % len(MOTIVATIONAL_QUOTES)]
    return jsonify({
        'text': quote['text'],
        'author': quote['author'],
